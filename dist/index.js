...
export default defineExtension({
    activate(api) {
        api.registerCommand({
            name: "sprint-setup",
            description: "Apply the software-sprint preset to the current pm workspace (settings + templates).",
            flags: [
                {
                    long: "force",
                    short: "f",
                ...
                },
                {
                    ...
                    short: "p",
                    type: "string",
                    description: 'Override the id_prefix written to settings.json (default: "sprint-").',
                },
            ],
            async run(context) {
...
Tip: items created with this preset use the "${prefixOverride ?? DEFAULT_SETTINGS.id_prefix}" id prefix.
`);
                }
                else {
                    console.log(`
